    ...
    public function run(): void
    {
        ...
        $activityDetailContents = [
            ...
            [
                ...
                'detail_content' => 'No se permite lanzar la pelota con las manos.',
                'display_order' => 1,
            ],
            [
                'activity_detail_id' => 17,
                'detail_content' => 'Solo se puede usar la toalla para atrapar y lanzar.',
                'display_order' => 2,
            ],
            [
                'activity_detail_id' => 17,
                'detail_content' => 'Si la pelota cae al suelo de la compañía que lanzó, el punto es para la otra compañía.',
                'display_order' => 3,
            ],
            [
                'activity_detail_id' => 17,
                'detail_content' => 'Las compañías que no estén jugando en el momento deberán animar a los jugadores.',
                'display_order' => 4,
            ],
            [
            ...
            [
                ...
                'detail_content' => 'Fomentar la concentración, la coordinación y la rapidez de reacción entre los jugadores, mientras escuchan y actúan con prontitud, aprendiendo a responder con atención y disposición a la guía del Espíritu en su vida.',
                'display_order' => 1,
            ],
            [
            ...
            [
                ...
                'detail_content' => 'Colocar la forma de “MeetUP” en un lugar visible y decorativo en el salón social.',
                'display_order' => 1,
            ],
            [
                'activity_detail_id' => 52,
                'detail_content' => 'Disponer de una caja con estrellas y marcadores. Preparar música de los jóvenes de Biblioteca del Evangelio para reproducirse durante el tiempo que tomen para escribir.',
                'display_order' => 2,
            ],
            [
